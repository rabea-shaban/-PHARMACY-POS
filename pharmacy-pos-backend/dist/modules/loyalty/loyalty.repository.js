...
export class LoyaltyRepository {
    ...
    async findTransactions(loyaltyAccountId, filters) {
    ...
    async applyPointsTransactionAtomic(params) {
        ...
        return prisma.$transaction(async (tx) => {
            ...
            if (newBalance < 0) {
                throw new BadRequestError(`Insufficient loyalty points. Current balance is ${account.totalPoints} points, requested redemption is ${Math.abs(pointsDelta)} points.`);
            }
