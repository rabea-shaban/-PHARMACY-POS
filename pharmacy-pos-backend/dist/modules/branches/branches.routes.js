...
import { createBranchSchema, updateBranchSchema, branchQuerySchema, branchIdParamSchema, } from './branches.validator.js';
...
branchesRouter.patch('/:id', authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER'), validateParams(branchIdParamSchema), validateBody(updateBranchSchema), branchesController.updateBranch);
// DELETE /api/v1/branches/:id - Deactivate branch (Platform & Pharmacy Managers)
branchesRouter.delete('/:id', authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER'), validateParams(branchIdParamSchema), branchesController.deleteBranch);
