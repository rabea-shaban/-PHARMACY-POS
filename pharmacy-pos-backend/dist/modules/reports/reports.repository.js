...
export class ReportsRepository {
    // 1. Sales Report Data
    async getSalesReportData(filters, startDate, endDate) {
    ...
    async getProductPerformanceData(filters, startDate, endDate) {
        const whereProduct = {
    ...
    async getInventoryReportData(filters, startDate, endDate) {
        const whereProduct = {
            ...(filters.categoryId ? { categoryId: filters.categoryId } : {}),
        };
    ...
    async getPurchaseReportData(filters, startDate, endDate) {
        const where = {
            createdAt: { gte: startDate, lte: endDate },
    ...
    async getExpenseReportData(filters, startDate, endDate) {
        const where = {
    ...
    async getCustomerReportData(_filters, startDate, endDate) {
    ...
    async getStaffReportData(filters, startDate, endDate) {
        const whereUser = {
    ...
    async getFinancialSummaryData(startDate, endDate) {
