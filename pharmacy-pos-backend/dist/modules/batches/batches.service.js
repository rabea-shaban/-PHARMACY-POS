...
export class BatchesService {
    ...
    async createBatch(input, actorId) {
        ...
        if (existing) {
            throw new ConflictError(`Batch '${batchNumber}' already exists for product '${product.name}'`);
        }
    ...
    async updateBatch(id, input, actorId) {
    ...
    async getFEFOBatches(productId, requiredQuantity) {
        await this.products.getProductById(productId);
