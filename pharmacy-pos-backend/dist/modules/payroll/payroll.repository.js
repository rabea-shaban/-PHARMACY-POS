...
export class PayrollRepository {
    ...
    async findByEmployeeAndPeriod(userId, periodStart, periodEnd) {
    ...
    async payPayrollAtomic(payrollId, paymentMethod = 'CASH', actorId, notes) {
