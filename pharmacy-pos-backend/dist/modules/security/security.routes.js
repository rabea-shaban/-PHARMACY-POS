...
import { securityQuerySchema, securityStatsQuerySchema, } from './security.validator.js';
...
securityRouter.get('/stats', validateQuery(securityStatsQuerySchema), securityController.getStats);
// 2. GET /api/v1/security/logs - Query login and security event history
securityRouter.get('/logs', validateQuery(securityQuerySchema), securityController.getLoginLogs);
