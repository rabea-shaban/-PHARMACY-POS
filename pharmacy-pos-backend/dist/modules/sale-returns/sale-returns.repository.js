...
export class SaleReturnsRepository {
    ...
    async findMany(filters) {
        ...
        if (returnNumber)
            where.returnNumber = { contains: returnNumber };
        if (saleId)
            where.saleId = saleId;
        if (customerId)
    ...
    async findSaleWithItems(saleId) {
    ...
    async createSaleReturnAtomic(plan) {
...
//# sourceMappingURL=sale-returns.repository.js.map