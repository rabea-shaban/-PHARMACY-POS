...
import {
  ...
  commissionTransactionQuerySchema,
  commissionRuleIdParamSchema,
  userIdParamSchema,
...
commissionsRouter.get(
  ...
  commissionsController.getRules
);
...
commissionsRouter.post(
  ...
  validateBody(createCommissionRuleSchema),
  commissionsController.createRule
);
...
commissionsRouter.patch(
  '/rules/:id',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER'),
  validateParams(commissionRuleIdParamSchema),
  validateBody(updateCommissionRuleSchema),
  commissionsController.updateRule
);
...
commissionsRouter.get(
  '/transactions',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'ACCOUNTANT'),
  validateQuery(commissionTransactionQuerySchema),
  commissionsController.getTransactions
);
...
commissionsRouter.get(
  '/summary',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'ACCOUNTANT'),
  commissionsController.getSummary
);
...
commissionsRouter.get(
  ...
  validateQuery(commissionTransactionQuerySchema),
  commissionsController.getStaffTransactions
);
