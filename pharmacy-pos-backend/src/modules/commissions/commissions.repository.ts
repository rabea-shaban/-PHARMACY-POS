...
export class CommissionsRepository {
  ...
  async findTransactions(filters: CommissionTransactionQueryFilters) {
    ...
    if (commissionRuleId) where.commissionRuleId = commissionRuleId;
  ...
  async getSummary(startDate?: Date, endDate?: Date) {
    ...
    const staffMap = new Map<
      string,
      { userId: string; userName: string; userRole: string; totalCommissions: number; salesCount: number }
    >();
