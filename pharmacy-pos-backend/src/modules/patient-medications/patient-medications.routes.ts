...
patientMedicationsRouter.get(
  '/',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'PHARMACIST', 'ACCOUNTANT'),
  validateQuery(patientMedicationQuerySchema),
  patientMedicationsController.getMedications
);
...
patientMedicationsRouter.get(
  ...
  patientMedicationsController.lookupPatientsByProduct
);
...
patientMedicationsRouter.get(
  ...
  patientMedicationsController.getCustomerMedications
);
...
patientMedicationsRouter.get(
  ...
  patientMedicationsController.getMedicationById
);
...
patientMedicationsRouter.post(
  '/',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'PHARMACIST'),
  validateBody(createPatientMedicationSchema),
  patientMedicationsController.createMedication
);

// PATCH /api/v1/patient-medications/:id - Update patient medication instruction
patientMedicationsRouter.patch(
  '/:id',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'PHARMACIST'),
  validateParams(medicationIdParamSchema),
  validateBody(updatePatientMedicationSchema),
  patientMedicationsController.updateMedication
);
...
patientMedicationsRouter.patch(
  ...
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'PHARMACIST'),
  validateParams(medicationIdParamSchema),
  patientMedicationsController.deactivateMedication
);
