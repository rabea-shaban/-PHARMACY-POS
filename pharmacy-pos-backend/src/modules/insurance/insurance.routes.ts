...
import {
  ...
  insuranceProviderIdParamSchema,
...
insuranceRouter.get(
  ...
  validateQuery(insuranceQuerySchema),
  insuranceController.getProviders
);
...
insuranceRouter.get(
  '/providers/:id',
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'PHARMACIST', 'ACCOUNTANT'),
  validateParams(insuranceProviderIdParamSchema),
...
insuranceRouter.post(
  ...
  validateBody(createInsuranceProviderSchema),
...
insuranceRouter.patch(
  ...
  authorize('PLATFORM_MANAGER', 'PHARMACY_MANAGER'),
  validateParams(insuranceProviderIdParamSchema),
  validateBody(updateInsuranceProviderSchema),
...
insuranceRouter.post(
  ...
  validateBody(createCustomerInsuranceSchema),
