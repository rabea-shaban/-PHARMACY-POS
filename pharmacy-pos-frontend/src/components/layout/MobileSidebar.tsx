...
const navItemDefs: NavItemDef[] = [
  ...
  },
  {
    ...
    roles: ['PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'BRANCH_MANAGER', 'PHARMACIST', 'ACCOUNTANT'],
  },
  {
    key: 'categories',
    href: '/categories',
  ...
  },
  {
    ...
    roles: ['PLATFORM_MANAGER', 'PHARMACY_MANAGER', 'BRANCH_MANAGER', 'ACCOUNTANT', 'PHARMACIST'],
  },
  {
    key: 'expenses',
    href: '/expenses',
