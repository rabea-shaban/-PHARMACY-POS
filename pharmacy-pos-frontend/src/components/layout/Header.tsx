...
import { useUnreadCount } from '../../features/notifications/hooks/useNotifications.js';
import { NotificationDropdown } from '../../features/notifications/components/NotificationDropdown.js';
import {
  Menu,
  Sun,
  Moon,
...
export const Header: React.FC = () => {
  ...
  // Hook automatically synchronizes unread count from real backend API with 30s polling
  useUnreadCount();
      ...
      <div className="flex items-center gap-2 sm:gap-2.5">
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2.5 rounded-2xl text-slate-600 hover:bg-sky-50 hover:text-sky-700 dark:text-slate-300 dark:hover:bg-[#1A2639] dark:hover:text-white transition-colors cursor-pointer"
